...
function getNumberTotal() { // 매개변수 정의 없음
    ...
    console.log(getNumberTotal(1, 2, "3", 4, 5,)); // 문자열때문에 정수형이 바뀐다.
    ...
    console.log(f2("홍길동"));
    const f2Arrow = name => "Hello, " + name; // 매개변수가 1개일때는 () 생략가능하다.
    console.log(f2Arrow("홍길동"));

    console.log(sandbox(3, 4, (v1, v2) => v1 * v2));    // 즉석함수 (즉석에서만들고 버린다.)
    console.log(snadbox(3, 4, (v1, v2) => v1 / v2)); 
